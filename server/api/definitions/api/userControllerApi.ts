...
export class UserControllerApi {
     ...
     * @param userRequest 
     */
    public async register (userRequest: UserRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserResponse;  }> {
     ...
     * 
     */
    public async user (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: string;  }> {
