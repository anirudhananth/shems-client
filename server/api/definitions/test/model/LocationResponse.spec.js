...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.LocationResponse();
  });
  ...
  describe('LocationResponse', function() {
    it('should create an instance of LocationResponse', function() {
      ...
      //var instance = new OpenApiDefinition.LocationResponse();
      //expect(instance).to.be.a(OpenApiDefinition.LocationResponse);
    });
