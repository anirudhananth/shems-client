  ...
  return (
    <div className="flex flex-col min-h-[100vh] bg-[#ffffff]">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <div className="inline-block rounded-lg bg-gray-100 px-3 py-1 text-sm dark:bg-gray-800">Feature</div>
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">Our Unique Features</h2>
                  <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                    Our platform provides unique features to help your business grow and succeed.
                  </p>
                </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-[#f7f7f7]">
        <p className="text-xs text-gray-500 dark:text-gray-400">© Company Name. All rights reserved.</p>
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
          ...
          <FacebookIcon className="w-4 h-4 mx-1" />
          <TwitterIcon className="w-4 h-4 mx-1" />
          <InstagramIcon className="w-4 h-4 mx-1" />
        </nav>
      </footer>
    </div>
  )
